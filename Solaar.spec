...
Version  : 1.1.14
Release  : 38
URL      : https://github.com/pwr/Solaar/archive/1.1.14/Solaar-1.1.14.tar.gz
Source0  : https://github.com/pwr/Solaar/archive/1.1.14/Solaar-1.1.14.tar.gz
...
%prep
%setup -q -n Solaar-1.1.14
cd %{_builddir}/Solaar-1.1.14
pushd ..
cp -a Solaar-1.1.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735831731
