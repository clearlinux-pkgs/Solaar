...
Version  : 1.1.11
Release  : 31
URL      : https://github.com/pwr/Solaar/archive/1.1.11/Solaar-1.1.11.tar.gz
Source0  : https://github.com/pwr/Solaar/archive/1.1.11/Solaar-1.1.11.tar.gz
...
%prep
%setup -q -n Solaar-1.1.11
cd %{_builddir}/Solaar-1.1.11
pushd ..
cp -a Solaar-1.1.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708552908
